...
class AddCategory extends React.Component {
  constructor(props) {
    super(props);
    const { image1, image2, image3 } = props.product;
    const files = [
      ...(image1 ? [image1] : []),
      ...(image2 ? [image2] : []),
      ...(image3 ? [image3] : []),
  ...
  handleOk = () => {
    ...
    if (_id && title && description && files && urlSlug && category && tags) {
      const body = { title, description, files, tags, category, urlSlug };
      this.props.updateProduct(body, _id);
    }
    this.setState({
      visible: false,
    });
...
export default connect(mapStateToProps, { updateProduct })(AddCategory);
