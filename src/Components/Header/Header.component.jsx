...
//images
const GoodYearLubricants =
  "https://i.ibb.co/WtS8Cg8/adp-gallery5ed66ac41cc89.png";
...
class Header extends React.Component {
  ...
  render() {
    ...
    console.log(lessThanOrEqualTo991);
                    ...
                    >
                      ...
                      >
                        <li
                          ...
                          aria-expanded={lessThanOrEqualTo991 ? "false" : false}
                          aria-label={
                        ...
                        >
                          <Link
                            ...
                            style={{ textAlign: "center" }}
                          >
                            <div id="tyre-finder" className="nav-link" to="/">
                              DISTRIBUTIONSHIP
                            </div>
                          </Link>
                        </li>
